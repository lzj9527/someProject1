	...
	jRange.prototype = {
		...
		render: function() {
			...
			if (this.inputNode.width() === 0 && !this.options.width) {
				...
				//console.log(this.inputNode.width());
		...
		setInputValue: function(pointer, v) {
			...
			var values2 = this.options.value.split(',');
            if (values2[0].indexOf(".")>0){
			$("#"+this.options.obj+"01").val(values2[0].substring(0,values2[0].indexOf(".") + 3));
		    }else{
		    $("#"+this.options.obj+"01").val(values2[0]);	
		    }

		   if (values2[1].indexOf(".")>0){
			$("#"+this.options.obj+"02").val(values2[1].substring(0,values2[1].indexOf(".") + 3));
			}else{
			$("#"+this.options.obj+"02").val(values2[1]);		
			}
