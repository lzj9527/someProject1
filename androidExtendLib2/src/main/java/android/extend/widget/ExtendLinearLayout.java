...
public class ExtendLinearLayout extends LinearLayout implements ViewObservable.IViewObservable, Checkable
{
	...
	public ExtendLinearLayout(Context context, AttributeSet attrs, int defStyle)
	{
